<x-app-layout>
    ...
    @if ($cartItems->isEmpty())
        <div class="flex items-start justify-center min-h-screen mt-8">
            <div class="text-4xl font-semibold text-gray-800 dark:text-gray-200 leading-tight">Empty bag</div>
        </div>
    @else
